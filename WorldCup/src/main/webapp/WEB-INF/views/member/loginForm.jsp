														...
														<form action="${contextPath}/member/login.do" method="post" name="frmLogin">
															<div class="form-group">
																<input type="text" name="id" class="form-style"
																	placeholder="ID" id="id" autocomplete="off"> 
																	<i class="input-icon uil uil-at"></i>
															</div>
															<div class="form-group mt-2">
																<input type="password" name="pwd" class="form-style"
																	placeholder="Password" id="pwd" autocomplete="off">
											...
											<div class="card-back">
												<div class="center-wrap">
													<div class="section text-center">
														...
														<c:choose>
															<c:when test="${idCheck == null || idCheck == false}">
															...
															<c:otherwise>
																<form action="${contextPath}/member/addMember.do" method="post">
																	<div class="form-group">
																		<input type="text" name="id" class="form-style" placeholder="ID" id="id" autocomplete="off"> 
																		<i class="input-icon uil uil-user"></i>
																		<button type="submit" disabled="disabled">중복확인</button>
																	</div>
																	<div class="form-group">
																		<input type="password" name="pwd" class="form-style" placeholder="Password" id="pwd" autocomplete="off">
																		<i class="input-icon uil uil-lock-alt"></i>
